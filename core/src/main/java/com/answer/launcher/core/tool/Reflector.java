...
import static com.answer.launcher.core.tool.PassHiddenUtils.*;

/**
 * Created by qiaopu on 2018/4/26.
 * modify by AnswerDev 2024/7/9.
 */
public class Reflector {
    public static final String LOG_TAG ="Reflector";
    private static final boolean isHidden = Build.VERSION.SDK_INT >= 28;
    ...
    public Reflector constructor(Class<?>... parameterTypes) throws Exception {
        try {
            mConstructor = (!isHidden) ?
                mType.getDeclaredConstructor(parameterTypes) : 
                getDeclaredConstructor(mType, parameterTypes);
    ...
    public Reflector constructorNoHidden(Class<?>... parameterTypes) throws Exception {
        try {
            mConstructor =
                    mType.getDeclaredConstructor(parameterTypes);
    ...
    public Reflector constructor(Constructor constructor) throws Exception {
        try {
    ...
    public Reflector fields(String... names) throws Exception {
        try {
    ...
    public Reflector sets(Object caller, String empty, Object... values) throws Exception {
        try {
            for (int i =0; values.length > i; i++) {
                Object value = values[i];
                mFields.get(i).set(caller, value);
            }
            return this;
        } catch (Throwable e) {
            throw new Exception("Oops!", e);
    ...
    public Reflector method(String name, Class<?>... parameterTypes) throws Exception {
        try {
            mMethod = (!isHidden) ? 
                ...
                getDeclaredMethod(mType, name, parameterTypes);
